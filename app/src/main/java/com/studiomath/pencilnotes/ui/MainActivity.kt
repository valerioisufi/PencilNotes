                ...
                Row {
                    Button(onClick = {
                        fileExplorerViewModel.createFile(
                            FileExplorerViewModel.FileType.FILE, "file"
                        )
                    }) {
                        Text(text = "file")
                    }
    ...
    Row(modifier = modifier
        ...
        .clickable {
            if (dataFile.type == FileExplorerViewModel.FileType.FILE) {
                ...
                intent.putExtra(
                    "titoloFile", dataFile.name.value
                )
                intent.putExtra(
                    "cartellaFile",
                    "documenti${fileExplorerViewModel.currentDirectoryPath.value}"
                )
